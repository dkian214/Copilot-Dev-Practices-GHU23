...
alias code_backend_geo_IP2Loc='type code_backend_geo_IP2Loc_js && cd_workshop && code ./backend/geolocation/IP2Location.js'
echo -e "alias code_backend_geo_IP2Loc='type code_backend_geo_IP2Loc_js && cd_workshop && code ./backend/geolocation/IP2Location.js'" >> ~/.bashrc
...
echo -e "alias run_backend_tests='type run_backend_tests && cd_workshop && cd backend && npm test'" >> ~/.bashrc
